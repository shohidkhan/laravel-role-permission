                   ...
                   <form action="{{ route('roles.update', $role->id) }}" method="POST">
                    @csrf
                        <div>
                            ...
                            <div class="my-3">
                                <input type="text" class="w-1/2 border-gray-300 rounded-md shadow-sm dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 dark:focus:border-blue-300 focus:ring focus:ring-green-600 focus:ring-opacity-50" name="name" placeholder="Name" value="{{ old('name', $role->name) }}">
                                @error('name')
                            ...
                            <div class="grid grid-cols-6">
                                ...
                                <div class="mt-3">
                                    ...
                                    {{ $roleHasPermissions->contains($permission->name) ? 'checked' : '' }}>
                                    {{-- {{ @if(in_array($permission->name, $roleHasPermissions->toArray())) checked @endif }} --}}
